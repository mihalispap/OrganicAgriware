...
drupal_add_js($app.'/controllers/view_item/agris-viewItemController.js',array('type'=>'file','scope'=>'footer','weight'=>107));
...
<?php print $cont['und']['0']['safe_value']; ?>
 ...
 <div id="akListing" ng-app="akListing" ng-controller="mainController" ng-init="init_finder('agrif','publications');"  class="col-xs-12 col-sm-12 col-md-12"  ng-cloak>
 		<!-- Language
